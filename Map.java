...
public class Map {
    ...
    static class Graph {
        ...
        public void AssignGraph(){
            ...
            graph.addEgde(8,22,new double[]{getDistance(7,10,10,10),95});
            graph.addEgde(22,8,new double[]{getDistance(7,10,10,10),95});
            ...
            graph.addEgde(27,23,new double[]{getDistance(10.42,6,13,6),20});
            graph.addEgde(23,27,new double[]{getDistance(10.42,6,13,6),20});
